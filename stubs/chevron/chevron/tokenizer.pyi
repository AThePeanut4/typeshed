...
def grab_literal(template: str, l_del: str | None) -> tuple[str, str]:
    """Parse a literal from the template"""
    ...
def l_sa_check(template: str, literal: str, is_standalone: bool) -> bool | None:
...
def r_sa_check(template: str, tag_type: str, is_standalone: bool) -> bool:
    ...
    ...
def parse_tag(template: str, l_del: str | None, r_del: str | None) -> tuple[tuple[str, str], str]:
