...
class OrderedMultiDict(dict[_KT, _VT]):
    ...
    def counts(self) -> OrderedMultiDict[_KT, _VT]:
        ...
        ...
    @classmethod
    def fromkeys(cls, keys: _KT, default: _VT | None = None) -> OrderedMultiDict[_KT, _VT]:
        """
        Create a dictionary from a list of keys, with all the values
        set to *default*, or ``None`` if *default* is not set.
        """
        ...
    def get(self, k: _KT, default: _VT | None = None) -> OrderedMultiDict[_KT, _VT]:
        """
    ...
    def todict(self, multi: bool = False) -> dict[_KT, _VT]:
        ...
        """
        ...
    def update(self, E: dict[_KT, _VT] | Iterable[object], **F) -> None:
        """
