...
class HTMLDoc(Doc):
    ...
    if sys.version_info >= (3, 11):
        ...
        def docroutine(  # type: ignore[override]
            ...
            """Produce HTML documentation for a function or method object."""
            ...
        def docproperty(self, object: object, name: str | None = None, mod: str | None = None, cl: Any | None = None) -> str:
            """Produce html documentation for a data descriptor."""
            ...
        def docdata(self, object: object, name: str | None = None, mod: Any | None = None, cl: Any | None = None) -> str:
            """Produce html documentation for a data descriptor."""
            ...
    if sys.version_info >= (3, 11):
...
class TextDoc(Doc):
    ...
    if sys.version_info >= (3, 11):
        ...
        def docroutine(self, object: object, name: str | None = None, mod: str | None = None, cl: Any | None = None) -> str:
            """Produce text documentation for a function or method object."""
            ...
        def docmodule(self, object: object, name: str | None = None, mod: Any | None = None) -> str:
            """Produce text documentation for a given module object."""
            ...
        def docproperty(self, object: object, name: str | None = None, mod: Any | None = None, cl: Any | None = None) -> str:
            """Produce text documentation for a data descriptor."""
            ...
        def docdata(self, object: object, name: str | None = None, mod: str | None = None, cl: Any | None = None) -> str:
            """Produce text documentation for a data descriptor."""
            ...
