...
if sys.platform == "win32" or sys.platform == "darwin":
    ...
    def proxy_bypass(host: str, proxies: Mapping[str, str] | None = None) -> Any:
        """
...
class HTTPPasswordMgr:
    ...
    def is_suburi(self, base: str, test: str) -> bool:
        """
        ...
        """
        ...
    def reduce_uri(self, uri: str, default_port: bool = True) -> tuple[str, str]:
