...
class DictConfigurator(BaseConfigurator):
    ...
    def common_logger_config(
        ...
        ...
    def configure_logger(self, name: str, config: _LoggerConfiguration, incremental: bool = False) -> None:
        """Configure a non-root logger from a dictionary."""
        ...
    def configure_root(self, config: _LoggerConfiguration, incremental: bool = False) -> None:
