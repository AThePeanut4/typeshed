...
def resolve_dotted_attribute(obj: Any, attr: str, allow_dotted_names: bool = True) -> Any:
    """
...
class SimpleXMLRPCDispatcher:  # undocumented
    ...
    def system_methodHelp(self, method_name: str) -> str:
        ...
        """
        ...
    def system_multicall(self, call_list: list[dict[str, _Marshallable]]) -> list[_Marshallable]:
        """
